...
def read_file():
    file = open("/Users/spenc/OneDrive/Documents/Python Projects/Allreduce_sigma.txt", "r") 
    for line in file:
        ans = line.split("\t")
        ans[4] = ans[4].rstrip()
...
def graph():
    pl.xticks(np.linspace(0, 262144, 19), xaxis)
    pl.grid()
    ...
    pl.title('Allreduce', fontsize=14)
    pl.show()
